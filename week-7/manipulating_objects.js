...
What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  At first I did not know how to make the children property have the value of an empty object. I got stuck on that for a minute but checked out the test code below and figured it out pretty quickly.

How difficult was it to add and delete properties outside of the object itself?
  Very simple. Having the delete method is very nice.

What did you learn about manipulating objects in this challenge?
  It is very easy to manipulate them. At first I reset terah's values and lost the original ones because I have syntax that just completely wiped out the old properties. I realized that at the end and went back to change the syntax so that it would work properly.
*/
